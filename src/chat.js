...
const initstate =[{text:"HELLO!! I am a simple conversation chatbot created by Olanrewaju,I am still in my learning phase,but will try to answer your question to the best of my abilities",sender:'bot'}]
